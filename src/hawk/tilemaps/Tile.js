...
var Tile = new Class({
  Mixins: [Components.AlphaSingle, Components.Flip, Components.Visible],
  ...
  updatePixelXY: function () {
    ...
    if (orientation === CONST.ORTHOGONAL) {
      ...
      this.pixelX =
        this.x * this.baseWidth + (this.y % 2) * (this.baseWidth / 2);
      ...
      if (staggerAxis === 'y') {
        ...
        if (staggerIndex === 'odd') {
          this.pixelY =
            this.y * this.baseHeight + (this.x % 2) * (this.baseHeight / 2);
        } else {
          this.pixelY =
            this.y * this.baseHeight - (this.x % 2) * (this.baseHeight / 2);
        }
