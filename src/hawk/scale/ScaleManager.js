...
var ScaleManager = new Class({
  ...
  boot: function () {
    ...
    if (
      scaleMode !== CONST.SCALE_MODE.RESIZE &&
      scaleMode !== CONST.SCALE_MODE.EXPAND
    ) {
  ...
  updateScale: function () {
    ...
    if (this.scaleMode === CONST.SCALE_MODE.NONE) {
      ...
      var clampedCanvasWidth = Clamp(
        canvasWidth,
        this.displaySize.minWidth,
        this.displaySize.maxWidth,
      );
      var clampedCanvasHeight = Clamp(
        canvasHeight,
        this.displaySize.minHeight,
        this.displaySize.maxHeight,
      );
      ...
      var clampedWindowHeight =
        windowHeight * (clampedCanvasHeight / canvasHeight);
